    ...
    <section class="rd-full-height" id="rd-home-patrocinador">
      ...
      <form class="rd-form" method="POST">
        <div class=" col-md-7 rd-mar-top-15 ">
          <input class=" rd-textarea " type="text" name="nome" placeholder="Empresa" maxlength="30" required>
        </div>
        ...
        <div class="col-md-7  rd-mar-top-15 ">
          <input class=" rd-textarea " type="text" name="pedido" placeholder="Tipo de parceria" maxlength="200" required>
        </div>
