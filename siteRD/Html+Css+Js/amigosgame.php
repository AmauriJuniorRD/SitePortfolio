...
<div class="rd-page-wrapper ">
  ...
  <div class="row justify-content-center rd-display-parceiros">
    <form action="amigosgameprocess.php" method="POST">
      ...
      <div class="form-group">
        <input class=" form-control rd-btn rd-btn-large rd-btn-border rd-teste-crud" type="text" name="nick" value="<?php echo $nick; ?>" placeholder="Nick" maxlength="30" required>
      </div>
      <div class="form-group">
        <input class=" form-control rd-btn rd-btn-large rd-btn-border rd-teste-crud" type="text" name="game" value="<?php echo $game; ?>" placeholder="Game" maxlength="40" required>
      </div>
      <div class="form-group">
        <input class=" form-control rd-btn rd-btn-large rd-btn-border rd-teste-crud" type="text" name="plataforma" value="<?php echo $plataforma; ?>" placeholder="Plataforma" maxlength="40" required>
      </div>
      <div class="form-group">
        <?php
        if ($update == true) :
